...
export const regions: RegionInfo[] = [
  {
    ...
    description:
      "‘오고 싶은 정선, 살고 싶은 정선’을 목표로 청소년 드론·미디어 교육과 지역 콘텐츠 제작을 지산학민 협력으로 연결합니다.",
...
export const seedCourses: SeedCourse[] = [
  ...
  },
  {
    ...
    region: "donghae",
    title: "동해시 청소년센터 드론캠프",
    summary:
      "FPV 드론 조립과 슈퍼볼 활동을 다루는 드론스포츠, 촬영과 DaVinci Resolve 편집을 잇는 드론미디어 투트랙 캠프입니다.",
    category: "청소년·드론",
  ...
  },
  {
    ...
    outcomes: ["3회·18시간 운영", "드론 제작·비행 기초역량", "STEAM 기반 진로 탐색"],
    published: true,
  },
  {
    ...
    summary:
      "항공촬영과 2D·3D 매핑, RAW 촬영, 영상편집과 AI 처리를 연결해 지역의 모습을 관광 콘텐츠로 제작한 과정입니다.",
    category: "드론·로컬 미디어",
  ...
  },
  {
    ...
    outcomes: ["기초에서 심화로 이어지는 연속 학습", "항공촬영·미디어 결과물", "AI 미디어 실무교육 연계"],
    published: true,
  },
];
...
export const fallbackReviews = [
  ...
  },
  {
    ...
    content:
      "드론 체험과 비행, 색보정·영상편집, 드론 4종 자격 이수가 긍정적으로 평가됐으며 비행·편집 난이도와 긴 수업시간은 개선 과제로 확인됐습니다.",
    published: true,
...
export const fallbackNotices = [
  ...
  },
  {
    id: 3,
    category: "모집",
    title: "2026 동해시 청소년센터 드론캠프 운영 예정 안내",
    content:
      "동해시 청소년센터에서 2026년 8월 4일부터 8일까지 5일간 청소년 드론캠프를 운영할 예정입니다. 참여 규모는 30명이며 드론스포츠와 드론미디어 투트랙으로 구성됩니다.\n\n드론스포츠 트랙은 슈퍼볼 활동과 FPV 드론 조립을 통해 조작 감각과 구조 이해를 높입니다. 드론미디어 트랙은 영상 촬영부터 DaVinci Resolve 편집까지 하나의 결과물로 연결합니다.\n\n세부 모집 방식과 참여 안내는 운영기관 확인 후 이 알림마당에 게시합니다.",
    published: true,
  ...
  },
  {
    ...
    content:
      "2025년 정선군 신동청소년아동장학복지센터에서 드론 메이커스 3회·18시간과 드론 항공촬영 및 미디어 4회·24시간 등 총 7회·42시간을 운영했습니다. 촬영·미디어 과정은 8명이 수료했고, 7명이 드론 4종 이수를 완료했습니다.\n\n2026년에는 드론 메이커스 기초반과 항공촬영·미디어 심화반을 거쳐 AI·Figma·영상편집까지 확장하는 ‘드론 메이크 샷’ 단계형 교육으로 연결할 예정입니다. 세부 일정은 확정 후 안내합니다.",
    published: true,
    createdAt: "2026-07-21 09:00:00",
  },
  {
